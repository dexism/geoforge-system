...
export class WorldMap {
    constructor(cols, rows) {
        ...
        // Cache for Hex objects (Flyweights)
        // REMOVED: We don't cache all of them to save memory.
        // this._hexObjects = new Array(this.size);
    ...
    // Initialize hex objects (lazy or upfront)
    // Upfront is safer for existing code compatibility
    // Initialize hex objects (lazy or upfront)
    // REMOVED: initHexObjects
